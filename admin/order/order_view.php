          ...
          <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
            <td data-label="รูปภาพ" class="text-start py-3 ps-md-4">
              <div class="mobile-right-content">
                <img src="/Project/admin/uploads/products/<?= htmlspecialchars($it['p_image'] ?? 'noimg.png') ?>" width="60" class="rounded shadow-sm border border-secondary" style="object-fit: cover; aspect-ratio: 1/1;">
              </div>
            </td>
