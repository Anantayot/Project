    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto align-items-lg-center py-3 py-lg-0 gap-lg-2">
                ...
                <li class="nav-item">
                    <a href="cart.php" class="nav-link cart-link transition-link <?= basename($_SERVER['PHP_SELF']) == 'cart.php' ? 'active' : '' ?>">
                ...
                <?php if (isset($_SESSION['customer_id'])): ?>
                    ...
                    <li class="nav-item dropdown d-none d-lg-block">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 custom-dropdown" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item transition-link" href="profile.php"><i class="bi bi-person-gear me-2"></i> โปรไฟล์ส่วนตัว</a></li>
